...
const Header = ({ navigateTo, currentView, generationMode }) => {
  ...
  return (
    <header className="mb-4 flex w-full items-center justify-between gap-4 border-b border-white/10 py-4">
      ...
      {currentView !== 'home' && (
        <button className="btn-secondary flex shrink-0 items-center gap-2" onClick={() => navigateTo(backTarget)}>
          <span>&larr;</span>
